...
BLOG_AUTHOR = "Scott Kinney"  # (translatable)
BLOG_TITLE = "DevOps Brain Dump"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://skinney6.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://skinney6.github.io/"
BLOG_EMAIL = "skinney6@gmail.com"
BLOG_DESCRIPTION = "DevOps Stuff"  # (translatable)
